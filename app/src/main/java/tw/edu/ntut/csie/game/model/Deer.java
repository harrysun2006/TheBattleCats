...
public class Deer extends Units
{
    public static int COOLDOWN = 4; //cooldown time

    public Deer(int x, int y, int shiftedX)
    {
        super();
...
//        _movingActive.setLocation(_displayX, _displayY);
    ...
    private void InitializeMovingActive()
    {
        ...
        _movingActive.setLocation(_displayX, _displayY);
        _movingActive.addFrame(R.drawable.deer_move1);
        _movingActive.addFrame(R.drawable.deer_move2);
        _movingActive.addFrame(R.drawable.deer_move3);
        _movingActive.addFrame(R.drawable.deer_move4);
