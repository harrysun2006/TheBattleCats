        ...
        synchronized (_engine) {
            ...
            switch (event.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    return _engine.getGameState().pointerPressed(pointers);
                case MotionEvent.ACTION_MOVE:
                    return _engine.getGameState().pointerMoved(pointers);
                case MotionEvent.ACTION_UP:
                    return _engine.getGameState().pointerReleased(pointers);
            }
            return true;
        }
    }
